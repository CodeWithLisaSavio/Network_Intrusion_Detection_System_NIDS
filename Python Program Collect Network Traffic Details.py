Python program that collects basic network traffic details relevant to the features you listed earlier for intrusion detection. This version uses psutil and socket to gather system-level network statistics. For deeper packet-level inspection, tools like scapy or pyshark would be needed—but this gives you a solid starting point
